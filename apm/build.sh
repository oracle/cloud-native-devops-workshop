...
APM_AGENT_DIST_URL=http://d2vwnrmpekozn2.cloudfront.net/ApmAgent.zip
...
# Download APM Agent distribution
wget ${APM_AGENT_DIST_URL}

# Extract Tomcat distribution
tar -xf ${TOMCAT_DIST}.tar.gz

# Extract APM Agent distribution
unzip ApmAgent.zip
...
cp ${MAVEN_PROJECT_DIR}/${MAVEN_PROJECT_WAR} ${TOMCAT_DIST}/webapps/ROOT.war
