...
**2.4.10** Enter the constant *Expression* or `"ORDER_MGMT_SUPER_USER"` (with double quotes), then hit the *Exit Expression Builder* button.
...
**2.4.13** Enter the following variables into the assignment action:
