...
**2.5.5** We will first map the EBS `Responsibility` value.  Left-click and drag from the little circle just to the right of the `$EBS_Responsibility` variable in the Source variable list.
...
|:---------------------------|:-----------|
| EBS_Responsibility        | Responsibility      |
| EBS_RespApplication        | RespApplication      |
| EBS_SecurityGroup          | SecurityGroup |
| EBS_NLSLanguage            | NLSLanguage |
| EBS\_OrgID                  | Org_iD      |
| EBS\_API\_Version\_Number  | P\_API\_Version\_Number      |

![](images/400/image037.png)

**2.5.8** Now we need to set the 
