...
**2.6.7** A message will appear on the top of the ICS Designer Portal indicating that the integration activation was successful.  The WSDL for the service endpoint will also be displayed.

   ![](images/300/image088.png)

### **2.7**:	Check the Service Endpoint

**2.7.1** Click on the WSDL link so we can ensure that this integration has an available service endpoint.

   ![](images/300/image086.png)

**2.7.2** The WSDL for you new ICS integration will now be displayed in your browser.

   ![](images/300/image087.png)

**2.7.3** Now that we have a modified integration with a new service endpoint, we can test it with some sample data to make sure it works.
