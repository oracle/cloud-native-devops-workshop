...
### **2.2**: Invoke the First Database Connection
...
**2.2.10** Edit the mapping by clicking on the little circle to the right of the `AccountName` source variable and dragging it on top of the little circle just to the left of the `CUSTOMER` target variable.
...
### **2.3**: Invoke the Second Database Connection
...
Click on the *mapping symbol* for the _getCustomerShippingInfo_ mapping - this will bring up 3 icons for activities we can do to the mapping.  

Click on the `pencil icon` to edit the mapping.

![](images/300/image062.png)

**2.3.8** Edit the mapping by clicking on the little circle to the right of the `AccountName` source variable and dragging it on top of the little circle just to the left of the `CUSTOMER` target variable.
...
### **2.4**: Map the Integration's Return Values
