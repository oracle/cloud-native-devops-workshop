...
<body>
	...
	<h1>
		Welcome to <a href="https://cloud.oracle.com/acc" target="_blank"><font
			color="red">Oracle </font> Application Container Cloud Service Demo</a>
	</h1>
	<p>
		This is a JavaSE back-end service for <a
			...
			href="https://cloud.oracle.com/en_US/mysql" target="_blank">Oracle
			Public MySQL service</a>
	</p>
	...
	<br>
	<a href="/mysql" target="_blank">MySQL database query/update</a>
	<br>
